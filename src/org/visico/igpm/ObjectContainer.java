...
{
	public ObjectContainer (SDataObject soapStorey, ServiceInterface service, Long revisionId) throws ServerException, UserException
	{
		this.service = service;
		this.revisionId = revisionId;
		this.main_object = soapStorey;
	
		getAllLinkedObjects(main_object);
	}
	...
	public void printObjectInfo()
	{
		...
		System.out.println("GUID: " + main_object.getGuid() 
				+ "  Type: " + main_object.getType()
